...
const addPurchases = (arr) => {
  // Solution code here...
  let totalAmount = arr.reduce((accumulator, item, index) => {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let numbOfelement = arr.reduce((accumulator, item, index) => {
    return index + 1;

  }, 0);
  return numbOfelement;
};
...
const returnNames = (arr) => {
  // Solution code here...
  let starWarsName = arr.reduce((accumulator, item, index) => {
...
const reversedString = (str) => {
 ...
 let newstr =  str.split("").reduce((accumulator,  item)=>{
